	...
	<div class="g-content">
		<div class="f-b1px">
			<table class="m-details" id="m-details">
				<tr>
					<td>专业ID</td>
					<td class="form_f_box" name="majoyID" ><input type="text" class="u-ipt iLock uLock" name="majoyID" /></td>
				</tr>
				<tr>
					<td>年级</td>
				...
				<tr>
					<td>学制</td>
					<td class="form_f_box" name="schooling" ><input type="text" class="u-ipt" name="schooling" /></td>
				</tr>
				<tr>
					<td colspan="2">
						<div class="f-bar">
